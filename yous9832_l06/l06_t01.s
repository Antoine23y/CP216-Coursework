...
stmfd   sp!, {fp, lr}       // push frame pointer
mov     fp, sp          // save current stack top to frame pointer
stmfd   sp!, {r1-r5}    // preserve other registers

ldr     r1, [fp, #4]   // Load str1 (first string address)
ldr     r2, [fp, #8]   // Load str2 (second string address)
ldr     r3, [fp, #12]  // Load max_length
...
ldmfd sp!, {r4-r5} // pop the preserved registers
ldmfd   sp!, {fp, pc} // restore the frame pointer and return 
