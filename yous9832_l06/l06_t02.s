...
ldr r3, =Max // load the max address
stmfd  sp!, {r3} // push max address to the stack
ldr r3, =Min // load the min address
stmfd  sp!, {r3} // push min address to the stack
ldr r3, =_Data // load the end address of the list
stmfd  sp!, {r3} // push end address of the list to the stack
ldr r3, =Data // load the start address of the list
stmfd  sp!, {r3} // push start address of the list to the stack
