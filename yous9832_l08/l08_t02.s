...
/* Note I do not want to change this main function, however if you comment and run readString 
it does everything listed that must be done for completion of the question. It compares with
the buffer size and it also reads the value until enter is detected. 
*/
_stop:
b _stop
...
stmfd sp!, {r0, r1, r2, r4, r5}     // preserve temporary registers
